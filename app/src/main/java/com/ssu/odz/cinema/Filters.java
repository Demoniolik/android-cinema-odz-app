...
public class Filters {
    ...
    public static Filters getDefault() {
        ...
        filters.setSortBy(Cinema.FIELD_AVG_RATING);
    ...
    public String getSearchDescription(Context context) {
        ...
        if (price > 0) {
            desc.append(" for ");
            desc.append("<b>");
            desc.append(CinemaUtil.getPriceString(price));
            desc.append("</b>");
        }
    ...
    public String getOrderDescription(Context context) {
        if (Cinema.FIELD_PRICE.equals(sortBy)) {
            return context.getString(R.string.sorted_by_price);
        } else if (Cinema.FIELD_POPULARITY.equals(sortBy)) {
